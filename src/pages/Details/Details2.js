    ...
    serviceQuestions:[
        {
            ...
            "required": true,
            "title": "Specialist",
            "summery": "به نیروی آقا نیاز دارید یا خانم؟",
...
const Details = (props) => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            setQuestions(questionsCooking.serviceQuestions)
        }, 1500);
    }, [])
